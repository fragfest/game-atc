...
export const stageConflict = (state, elapsedTime, entityManagerArr, completeStageFn) => {
  if (!event) {
  ...
  if((elapsedTime > ElapsedTimes.ConflictFirstInputMs) && (event === Events.WaitForInput0)) {
